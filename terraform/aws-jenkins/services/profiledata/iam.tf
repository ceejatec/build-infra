    ...
    "Statement": [
      {
        ...
        "Resource": [
          ...
          "${aws_ssm_parameter.couchbase_server_macos_cv_ssh_config.arn}",
          "${aws_ssm_parameter.couchbase_server_shared_m2_settings.arn}",
          "${aws_ssm_parameter.couchbase_server_shared_ssh_environment.arn}",
          "${aws_ssm_parameter.couchbase_server_shared_gitconfig.arn}",
          "${aws_ssm_parameter.couchbase_server_linux_cv_ssh_config.arn}",
          "${aws_ssm_parameter.couchbase_server_linux_build_ssh_config.arn}",
