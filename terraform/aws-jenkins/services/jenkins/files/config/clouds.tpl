    ...
    <com.cloudbees.jenkins.plugins.amazonecs.ECSCloud plugin="amazon-ecs@1.37">
      ...
      <templates>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-amzn2</taskDefinitionOverride>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-centos7</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-centos8</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-debian8</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-debian8-alice</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-debian9</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-debian10</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-suse15</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-ubuntu16</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-ubuntu18</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
        ...
        <com.cloudbees.jenkins.plugins.amazonecs.ECSTaskTemplate>
          ...
          <taskDefinitionOverride>${task_prefix}-couchbase-server-build-ubuntu20</taskDefinitionOverride>
          <defaultCapacityProvider>true</defaultCapacityProvider>
          <remoteFSRoot>/home/jenkins</remoteFSRoot>
          <subnets>${subnets}</subnets>
          <securityGroups>${security_groups}</securityGroups>
